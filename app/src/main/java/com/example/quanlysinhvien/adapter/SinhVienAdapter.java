...
public class SinhVienAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view== null){
            ...
            viewHoder.tvMaSV_334 = view.findViewById(R.id.tv_masv_330);
            viewHoder.tvHoTen_334 = view.findViewById(R.id.tv_hoten_330);
            viewHoder.tvDienThoai_334 = view.findViewById(R.id.tv_dienthoai_330);
            viewHoder.tvEmail_334 = view.findViewById(R.id.tv_email_330);
            viewHoder.ivGioiTinh_334 = view.findViewById(R.id.tvgioitinh_330);
